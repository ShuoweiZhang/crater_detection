...
train_percent       = 0.9
VOCdevkit_path  = 'E:/DATA/Remote/data/datasets/COCO/result'

VOCdevkit_sets  = [('lroc', 'train'), ('lroc', 'val')]
...
if __name__ == "__main__":
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        print("Generate lroc_train.txt and lroc_val.txt for train.")
        type_index = 0
        for year, image_set in VOCdevkit_sets:
            ...
            type_index += 1
            list_file.close()
        print("Generate lroc_train.txt and lroc_val.txt for train done.")
