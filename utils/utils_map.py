...
def get_map(MINOVERLAP, draw_plot, score_threhold=0.5, path='./map_out1'):
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            if draw_plot:
                ...
                fig.savefig(RESULTS_FILES_PATH + "/AP/" + class_name + ".pdf")
                fig.savefig(RESULTS_FILES_PATH + "/AP/" + class_name + ".png")
                plt.cla()

                plt.plot(score, F1, "-", color='red', label='F1')
                ...
                plt.plot(score, rec, "-", color='green', label='Recall')
                ...
                plt.plot(score, prec, "-", color='blue', label='Precision')
                axes.legend()
                ...
                fig.savefig(RESULTS_FILES_PATH + '/res.pdf')
                plt.cla()
